...
- Define ownership via glob patterns in task descriptions: `File ownership: src/workshopman-core/api/*, src/workshopman-core/models/*`
- Ownership boundaries are at the file level within the monorepo — any `src/` path is valid
