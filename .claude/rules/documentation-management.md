...
> **SEE ALSO**: `documentation-navigation.md` for AI routing rules (where to read/write docs)

### Roadmap & Changelog Maintenance
- **Project Roadmap** (`./docs/sprints/roadmap.md`): Living document tracking project phases, milestones, and progress (create when needed)
- **Project Changelog** (`./docs/CHANGELOG.md`): Detailed record of all significant changes, features, and fixes (create when needed)
- **System Architecture** (`./docs/knowledge-architecture/01-system-overview.md`): High-level system overview, service map, architecture patterns
- **Code Standards** (`./docs/knowledge-standards/01-code-style.md`): Formatting, linting, naming conventions, code style rules
