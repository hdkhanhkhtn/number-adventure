...
2. Get LOC: `find docs/ -name '*.md' -exec wc -l {} + | sort -rn`
3. Strategy:
...
- `docs/knowledge-overview/01-project-identity.md`: Update project overview and PDR
- `docs/knowledge-source-base/00-index.md`: Update codebase summary
- `docs/knowledge-standards/01-code-style.md`: Update codebase structure and code standards
- `docs/knowledge-architecture/01-system-overview.md`: Update system architecture
- `docs/sprints/roadmap.md`: Update project roadmap
- `docs/runbooks/deployment-guide.md` [optional]: Update deployment guide
- `docs/knowledge-standards/05-design-guidelines.md` [optional]: Update design guidelines
