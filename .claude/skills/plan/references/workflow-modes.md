...
1. Read codebase docs (`docs/knowledge-source-base/00-index.md`, `docs/knowledge-standards/01-code-style.md`, `docs/knowledge-architecture/01-system-overview.md`)
