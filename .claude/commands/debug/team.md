...
**Mailbox Location**: `./plans/reports/MAILBOX-{date}.md` — All agents APPEND only, never overwrite.
...
| Phase              | Output                                         |
| ------------------ | ---------------------------------------------- |
| P1: Symptoms       | `./plans/reports/debugs/SYMPTOMS-{issue}`         |
| P2: Hypotheses     | `./plans/reports/debugs/HYPOTHESES-{issue}`       |
| P3: Evidence       | `./plans/reports/debugs/EVIDENCE-{issue}`         |
| P4: Final Report   | `./plans/reports/debugs/DEBUG-REPORT-{issue}`     |
...
**Deliverable**: `./plans/reports/debugs/SYMPTOMS-{issue}`
...
**Prerequisite**: **READ** `./plans/reports/debugs/SYMPTOMS-{issue}`
...
**Deliverable**: `./plans/reports/debugs/HYPOTHESES-{issue}`
...
**Prerequisite**: **READ** `./plans/reports/debugs/HYPOTHESES-{issue}`
...
**Deliverable**: `./plans/reports/debugs/EVIDENCE-{issue}`
...
**Deliverable**: `./plans/reports/debugs/DEBUG-REPORT-{issue}`
...
## Mailbox Reference
Full debate history: `./plans/reports/MAILBOX-{date}.md`

## Next Actions
1. ✅ **Root Cause** — Identified (triangle-validated across all phases)
2. 📊 **Report** — `./plans/reports/debugs/DEBUG-REPORT-{issue}`
