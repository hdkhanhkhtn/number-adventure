...
**Mailbox**: `./plans/reports/MAILBOX-{date}.md` — All triangle agents READ/APPEND. Never overwrite.
...
| Phase / Team     | Output                                          |
| ---------------- | ----------------------------------------------- |
| Phase 1 (Scope)  | `./plans/reports/scouts/SCOUT-{scope}`             |
| Phase 2 (Review) | Review findings in Mailbox                      |
| Phase 3 (Plan)   | `./plans/reports/reviews/REVIEW-REPORT-{scope}`    |
| Phase 4 (Summary)| `./plans/reports/reviews/REVIEW-{scope}`           |
...
**Plan Compliance**: If `./plans/reports/plans/PLAN-{scope}` exists → verify code matches plan, flag deviations.
...
**Deliverable**: `./plans/reports/scouts/SCOUT-{scope}`
...
**Prerequisite**: **READ** `./plans/reports/scouts/SCOUT-{scope}`
...
**Deliverable**: `./plans/reports/reviews/REVIEW-REPORT-{scope}`
...
**Prerequisite**: **READ** `./plans/reports/reviews/REVIEW-REPORT-{scope}`
...
**Deliverable**: `./plans/reports/reviews/REVIEW-{scope}`
