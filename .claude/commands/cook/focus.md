...
| Agent        | Output                                          |
| ------------ | ----------------------------------------------- |
| brainstormer | `./plans/reports/brainstorms/BRAINSTORM-{feature}` |
| researcher   | `./plans/reports/researchers/RESEARCH-{feature}`   |
| scouter      | `./plans/reports/scouts/SCOUT-{feature}`           |
| designer     | `./plans/reports/designs/DESIGN-{feature}`         |
| planner      | `./plans/reports/plans/PLAN-{feature}`             |
...
| Output       | `./plans/reports/plans/PLAN-{feature}`                 |
