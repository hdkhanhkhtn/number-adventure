...
| Phase / Team    | Output                                          |
| --------------- | ----------------------------------------------- |
| Phase 1 (Disc.) | `./plans/reports/brainstorms/BRAINSTORM-{feature}` |
| Phase 2 (Res.)  | `./plans/reports/researchers/RESEARCH-{feature}`   |
| Phase 2 (Res.)  | `./plans/reports/scouts/SCOUT-{feature}`           |
| Phase 4 (Des.)  | `./plans/reports/designs/DESIGN-{feature}`         |
| Phase 5 (Plan)  | `./plans/reports/plans/PLAN-{feature}`             |
...
**Deliverable**: Requirements + discovery report in `./plans/reports/brainstorms/BRAINSTORM-{feature}`
...
**Deliverable**: `./plans/reports/researchers/RESEARCH-{feature}` + `./plans/reports/scouts/SCOUT-{feature}`
...
**Deliverable**: `./plans/reports/designs/DESIGN-{feature}`
...
**Deliverable**: `./plans/reports/plans/PLAN-{feature}`
