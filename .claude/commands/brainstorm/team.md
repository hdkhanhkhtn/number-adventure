...
**LOAD now** (path `./rules/` or `.claude/rules/`):
...
| Phase              | Output                                          |
| ------------------ | ----------------------------------------------- |
| P1: Diverge        | `./plans/reports/brainstorms/IDEAS-{topic}`        |
| P2: Converge       | `./plans/reports/brainstorms/ANALYSIS-{topic}`     |
| P3: Synthesize     | `./plans/reports/brainstorms/BRAINSTORM-{topic}`   |
...
**Deliverable**: `./plans/reports/brainstorms/IDEAS-{topic}`
...
**Prerequisite**: **READ** `./plans/reports/brainstorms/IDEAS-{topic}`
...
**Deliverable**: `./plans/reports/brainstorms/ANALYSIS-{topic}`
...
**Prerequisite**: **READ** `./plans/reports/brainstorms/ANALYSIS-{topic}`
...
**Deliverable**: `./plans/reports/brainstorms/BRAINSTORM-{topic}`
