...
deliverable_files:
  ...
  researcher: "./plans/reports/researchers/RESEARCH-{topic}"
  scouter: "./plans/reports/scouts/SCOUT-{topic}"
  brainstormer_synthesis: "./plans/reports/brainstorms/BRAINSTORM-{topic}" # MANDATORY OUTPUT
...
**MANDATORY**: CREATE `./plans/reports/researchers/RESEARCH-{topic}`
...
| **Prerequisite** | READ `./plans/reports/researchers/RESEARCH-{topic}` + `./plans/reports/scouts/SCOUT-{topic}` |
...
- CREATE `./plans/reports/brainstorms/BRAINSTORM-{topic}`

**Exit Criteria:**

- [ ] Brainstorm file created at `./plans/reports/brainstorms/BRAINSTORM-{topic}`
