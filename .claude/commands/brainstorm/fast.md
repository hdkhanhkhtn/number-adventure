...
```yaml
deliverable_files:
  brainstormer: "./plans/reports/brainstorms/BRAINSTORM-{topic}" # MANDATORY for substantial synthesis
...
**MANDATORY**: CREATE `./plans/reports/brainstorms/BRAINSTORM-{topic}` for synthesis
