...
**Location**: `./plans/reports/MAILBOX-{date}.md`
...
| Phase / Team       | Output                                         |
| ------------------ | ---------------------------------------------- |
| Phase 1 (Invest.)  | `./plans/reports/debugs/INVESTIGATION-{issue}`    |
| Phase 2 (RCA)      | `./plans/reports/debugs/DEBUG-{issue}`            |
| Phase 3 (Plan)     | `./plans/reports/plans/PLAN-{issue}`              |
| Phase 5 (Test)     | `./plans/reports/qa/QA-{issue}`                   |
...
**Deliverable**: `./plans/reports/debugs/INVESTIGATION-{issue}`
...
**Prerequisite**: **READ** `./plans/reports/debugs/INVESTIGATION-{issue}`
...
**Deliverable**: `./plans/reports/debugs/DEBUG-{issue}`
...
**Prerequisite**: **READ** `./plans/reports/debugs/DEBUG-{issue}`
...
**Deliverable**: `./plans/reports/plans/PLAN-{issue}`
...
**Prerequisite**: **READ and FOLLOW** `./plans/reports/plans/PLAN-{issue}`
...
**Deliverable**: `./plans/reports/qa/QA-{issue}`
