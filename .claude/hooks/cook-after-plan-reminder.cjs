...
try {
  ...
  try {
    ...
    // [Superpowers] No-placeholder validation reminder
    console.log('IMPORTANT: Verify plan has NO placeholders (exact paths, exact commands, exact code).');
    console.log('If plan contains "implement here", "add appropriate", "etc." → rerun planner with specifics.');
    if (planPath) {
