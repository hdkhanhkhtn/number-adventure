...
1. CHECK PROJECT DOCS (if ./docs/ exists):
   - docs/knowledge-architecture/ → Existing architecture (02-components.md)
   - context/ → Data models, domain schema
   - docs/knowledge-standards/ → Naming conventions (01-code-style.md)
   → USE these for schema naming and structure

2. CHECK: ./plans/reports/plans/PLAN-{feature}
