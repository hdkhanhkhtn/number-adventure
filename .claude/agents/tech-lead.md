...
1. CHECK PROJECT DOCS (if ./docs/ exists):
   - docs/knowledge-standards/ → Enforce these (01-code-style.md)
   - docs/knowledge-architecture/ → Architecture constraints (02-components.md)
   - context/ → Data/API constraints, domain concepts
   → VERIFY all work aligns with project standards

2. IF ./plans/reports/plans/PLAN-{feature} exists:
   - READ completely
