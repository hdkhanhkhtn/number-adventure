...
- docs/knowledge-architecture/ → Technical context (02-components.md, overview files)
- docs/knowledge-standards/ → Code standards (01-code-style.md)
- context/ → Domain concepts, business workflows
...
**Small** (≤ 150 lines): Single file `./plans/reports/researchers/RESEARCH-{topic}.md`
**Large** (> 150 lines OR ≥ 4 sections): Folder `./plans/reports/researchers/{topic}/` → create `00-index.md` first, then each section `01-*.md`, `02-*.md` sequentially.
