...
- docs/knowledge-standards/ → Design standards (01-code-style.md)
- context/ → User flows, business workflows
...
**Small** (≤ 150 lines): Single file `./plans/reports/designs/DESIGN-{feature}.md`
**Large** (> 150 lines OR ≥ 4 sections): Folder `./plans/reports/designs/{feature}/` → create `00-index.md` first, then each section `01-*.md`, `02-*.md` sequentially.
