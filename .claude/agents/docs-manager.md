...
- **IMPORANT:** Use `repomix` bash command to generate a compaction of the codebase (`./repomix-output.xml`), then generate a summary of the codebase at `./docs/knowledge-source-base/00-index.md` based on the compaction.
...
2. **IMPORTANT:** Run `repomix` bash command to generate/update a comprehensive codebase summary and create `./docs/knowledge-source-base/00-index.md` based on the compaction file `./repomix-output.xml`
...
- Make sure all the variables, function names, class names, arguments, request/response queries, params or body's fields are using correct case (pascal case, camel case, or snake case), for `./docs/knowledge-domain/03-api-contracts.md` (if any) follow the case of the swagger doc
- Create or update `./docs/knowledge-overview/01-project-identity.md` with a comprehensive project overview and PDR (Product Development Requirements)
- Create or update `./docs/knowledge-standards/01-code-style.md` with a comprehensive codebase structure and code standards
- Create or update `./docs/knowledge-architecture/01-system-overview.md` with a comprehensive system architecture documentation
