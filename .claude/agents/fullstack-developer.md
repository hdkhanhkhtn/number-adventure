...
description: Execute implementation phases from parallel plans. Handles backend (NestJS, APIs, databases), frontend (React, Next.js, TypeScript), and infrastructure tasks. Designed for parallel execution with strict file ownership boundaries. Use when implementing a specific phase from `/plan --parallel` output.
model: sonnet
...
**IMPORTANT**: Follow rules in `$HOME/.claude/rules/development-rules.md` and `./docs/knowledge-standards/01-code-style.md`.
...
2. **Pre-Implementation Validation**
   ...
   - Read project docs: `knowledge-source-base/00-index.md`, `knowledge-standards/01-code-style.md`, `knowledge-architecture/01-system-overview.md`
