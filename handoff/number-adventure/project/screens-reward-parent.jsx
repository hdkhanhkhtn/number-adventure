...
// ─── SESSION END / TIME'S UP ─────────────────────────────────
function SessionEndScreen({ profile, minutesPlayed = 5, starsToday = 6, streak = 3, onHome }) {
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <GardenBg variant="lavender">
        <Sparkles count={10} color="#D9C7F0"/>
      </GardenBg>
      <div style={{ position: 'relative', zIndex: 1, height: '100%', padding: '48px 24px 36px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>

        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#5D3F94', letterSpacing: 0.8, marginBottom: 8 }}>
            TIME TO REST
          </div>
          <div style={{ fontSize: 32, fontWeight: 700, color: '#2D3A2E', lineHeight: 1.1 }}>
            Great work today,<br/>{profile.name}! 😴
          </div>
        </div>

        <div className="bobble">
          <BapMascot size={160} mood="sleep" color={profile.color}/>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: '#5D3F94', letterSpacing: 0.5, marginBottom: 14 }}>
            TODAY'S SUMMARY
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-around', textAlign: 'center' }}>
            <div>
              <div style={{ fontSize: 36, fontWeight: 700, color: '#C14A2A', fontFamily: 'var(--font-num)' }}>{minutesPlayed}</div>
              <div style={{ fontSize: 12, color: '#6B7A6C', fontWeight: 600 }}>minutes played</div>
            </div>
            <div style={{ width: 1, background: 'rgba(46,90,58,0.1)' }}/>
            <div>
              <div style={{ fontSize: 36, fontWeight: 700, color: '#B87C0E', fontFamily: 'var(--font-num)' }}>{starsToday}</div>
              <div style={{ fontSize: 12, color: '#6B7A6C', fontWeight: 600 }}>stars earned ⭐</div>
            </div>
            <div style={{ width: 1, background: 'rgba(46,90,58,0.1)' }}/>
            <div>
              <div style={{ fontSize: 36, fontWeight: 700, color: '#C14A2A', fontFamily: 'var(--font-num)' }}>{streak}</div>
              <div style={{ fontSize: 12, color: '#6B7A6C', fontWeight: 600 }}>day streak 🔥</div>
            </div>
          </div>
          ...
          <div style={{
            ...
            background: '#F0EAF8', border: '1.5px solid #D9C7F0',
            fontSize: 13, color: '#5D3F94', fontWeight: 600,
        ...
        <BigButton color="sage" size="xl" onClick={onHome} icon="🏠">
          Back to Home
        </BigButton>
      </div>
    </div>
...
Object.assign(window, { RewardScreen, StreakScreen, SessionEndScreen, ParentDashboard, ParentSettings, ParentReport });
